class Message < ApplicationRecord
  ...
  after_create_commit { [MessageBroadcastWorker.perform_async(self.id),  MessageNotificationWorker.perform_in(15.seconds, self.id), MessageEmailWorker.perform_in(2.minutes, self.id)] }
