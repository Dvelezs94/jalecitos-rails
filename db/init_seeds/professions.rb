...
["Abogado", "Actor", "Agente de viajes", "Albañil", "Ama de casa", "Arqueólogo", "Arquitecto", "Asesor, Consultor", "Astronauta", "Azafata",
 ...
 "Marinero", "Mecánico", "Meteorólogo", "Minero", "Modelo", "Modista", "Monje", "Médico", "Niñera", "Oficinista", "Panadero", "Pastelero, Repostero",
 "Payaso", "Peluquero", "Periodista", "Persona de limpieza", "Pescador", "Pintor", "Policía", "Político", "Portero, Conserje", "Profesor",
 "Programador", "Psicólogo", "Psiquiatra", "Químico, Farmaceútico", "Recepcionista", "Secretario", "Socorrista", "Taxista", "Telefonista",
 "Trabajador social", "Vendedor", "Veterinario", "Zapatero", "Deportista"
  ]
  end
end
